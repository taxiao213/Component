...
public class LoadingFrameLayout extends FrameLayout {
    ...
    private void initView(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.LoadingFrameLayout);
        boolean data_empty = typedArray.getBoolean(R.styleable.LoadingFrameLayout_data_empty, false);
        boolean net_error = typedArray.getBoolean(R.styleable.LoadingFrameLayout_net_error, false);
        typedArray.recycle();

        View view = LayoutInflater.from(context).inflate(R.layout.loading_framelayout, this);
