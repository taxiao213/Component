...
public class SkinResources {
    ...
    public static SkinResources getInstances() {
        if (mInstances == null) {
     ...
     */
    public void setSkinResources(Application application, String path) {
     ...
     */
    public Object getBackgroud(Activity activity, int id) {
     ...
     * 可能是Mipmap
     */
    public Object getObject(Activity activity, int id) {
        Object object = null;
     ...
     * 获取 Color
     */
    public ColorStateList getColorStateList(Activity activity, int resId) {
        if (SkinEngine.getInstances().isLoadInternal()) {
            // 加载内部资源，夜间 白天模式切换
